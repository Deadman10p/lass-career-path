  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        setter: {
          DEFAULT: "hsl(var(--setter))",
          foreground: "hsl(var(--setter-foreground))",
          soft: "hsl(var(--setter-soft))",
        },
        student: {
      ...
      animation: {
        ...
        "fade-in-up": "fade-in-up 0.5s var(--ease-out-soft)",
        "scale-in": "scale-in 0.3s var(--ease-out-soft)",
        "slide-in-right": "slide-in-right 0.35s var(--ease-out-soft)",
